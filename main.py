...
def get_price_eth_for_token(token_address, block_number):
    ...
    thegraph_v3_url = 'https://gateway.thegraph.com/api/{API_KEY}/subgraphs/id/5zvR82QoaXYFyDEKLZ9t6v9adgnptxYpKpSbxtgVENFV'
    thegraph_v2_url = 'https://gateway.thegraph.com/api/{API_KEY}/subgraphs/id/EYCKATKGBKLWvSfwvBjzfCBmGwYNdVkduYXVivCsLRFu'
...
def main():
    ...
    #sandwich_processor()  #  processing function for Sandwich
    #jit_processor()       #  processing function for JIT Sandwich
    #atomic_processor()    #  processing function for Atomic
    #searcher_processing() #  processing function for Searcher
